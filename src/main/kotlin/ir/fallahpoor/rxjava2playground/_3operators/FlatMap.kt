...
fun main() {
    ...
    /*
     * The above solution is highly unsatisfactory because we lose the ability to transform
     * the data stream.
     * If we wanted to modify each URL, We'd have to do it all in the Subscriber.
     *
     * Now take a look at next solution.
     */
    query("Hello, world!")
        .subscribe { urls: List<String> ->
    ...
    /*
     * In the above solution We've gotten rid of the 'for' loop, but the resulting code
     * is a mess. We've got nested subscriptions now. It's ugly and hard to modify.
     * Remember that one of RxJava advantages was to get rid of nested callbacks but now
     * we're having nested subscriptions!
     *
     ...
     *
     * flatMap() does NOT guarantee any specific order of events. So interleaving of events
     * of Observables may occur.
     */

    /*
     * The following solution is a better version of last one. It's using the
...
// Returns a hypothetical list of website URLs based on a text search
